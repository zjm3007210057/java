...
public class GettingStartedLoadData {
    ...
    private static AmazonDynamoDBClient client = new AmazonDynamoDBClient(
            ...
            });//.withEndpoint("dynamodb.cn-north-1.amazonaws.com.cn");
    private static DynamoDB dynamoDB = new DynamoDB(client);
    private static SimpleDateFormat dateFormatter = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'");
    private static String productCatalogTableName = "ucs-test-dynamodb-passport-appid-oauth-rel";
    private static String forumTableName = "Forum";
