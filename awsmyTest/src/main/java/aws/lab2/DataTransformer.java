...
public class DataTransformer {
    ...
    public static final String INPUT_BUCKET_NAME = "lab-2-zjm-input-bucket";

    // STUDENT TODO: Update output bucket name to a unique bucket name.
    public static final String OUTPUT_BUCKET_NAME = "lab-2-zjm-output-bucket";
    ...
    public DataTransformer(){
        client = (AmazonS3Client) AmazonS3ClientBuilder.standard().build();
    }
